      ...
      <div className="max-w-[1240px] mx-auto px-5 sm:px-8 grid grid-cols-1 lg:grid-cols-12 gap-5 md:gap-8">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h2 className="font-heading font-bold text-[40px] sm:text-[48px] md:text-[64px] lg:text-[72px] text-meb-dark leading-[1.05] tracking-tight mb-8">
              Passez à <br />
              l'action<span className="text-meb-green">.</span>
            </h2>
